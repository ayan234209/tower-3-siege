...
function draw() {
  ...
  if(score > 2499){
    ...
    text("YOU WIN!!", 275, 250);
    text("Refresh the Page If you want to play again", 1, 350);
  ...
  text("press the space bar ", 750, 400);
  text("to take another shot", 775, 450);
  
  text("Destroy the boxes to win !!!", 350, 75);
}
